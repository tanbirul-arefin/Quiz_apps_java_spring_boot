...
public class QuestionInitilizer {
    ...
    public void init() {
        ...
        questionForm.add(new Question(2,
        ...
        questionForm.add(new Question(3,
        ...
        questionForm.add(new Question(4,
        ...
        questionForm.add(new Question(5,
        ...
        questionForm.add(new Question(6,
        ...
        questionForm.add(new Question(7,
        ...
        questionForm.add(new Question(8,
        ...
        questionForm.add(new Question(9,
        ...
        questionForm.add(new Question(10,
